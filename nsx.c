...
#else
extern const int32_t twi_table_32_rfft_128[32 * 2];
#endif
...
#else
// Q15
const int32_t delta32[65] = {
    42598, 42598, 42598, 42598, 42598, 42598,
	42598, 42598, 42598, 42598, 42598, 42598,
	42598, 42598, 42598, 42598, 46163, 49728,
	53293, 56859, 60424, 63989, 67554, 71119,
	74684, 78249, 81815, 85380, 88945, 92510,
	96075, 99640, 103206, 106771, 110336, 113901,
	117466, 121031, 124597, 128162, 131727, 135292,
	138857, 142422, 145987, 149553, 153118, 156683,
	160248, 163840, 163840, 163840, 163840, 163840,
	163840, 163840, 163840, 163840, 163840, 163840,
	163840, 163840, 163840, 163840, 163840};
// Q14
static int16_t kBlocks128w256x[128] = {
    0, 402, 803, 1205, 1605, 2005,
	2404, 2801, 3196, 3589, 3980, 4369,
	4756, 5139, 5519, 5896, 6269, 6639,
	7005, 7366, 7723, 8075, 8423, 8765,
	9102, 9434, 9759, 10079, 10393, 10701,
	11002, 11297, 11585, 11866, 12139, 12406,
	12665, 12916, 13159, 13395, 13622, 13842,
	14053, 14255, 14449, 14634, 14810, 14978,
	15136, 15286, 15426, 15557, 15678, 15790,
	15892, 15985, 16069, 16142, 16206, 16260,
	16305, 16339, 16364, 16379, 16384, 16379,
	16364, 16339, 16305, 16260, 16206, 16142,
	16069, 15985, 15892, 15790, 15678, 15557,
	15426, 15286, 15136, 14978, 14810, 14634,
	14449, 14255, 14053, 13842, 13622, 13395,
	13159, 12916, 12665, 12406, 12139, 11866,
	11585, 11297, 11002, 10701, 10393, 10079,
	9759, 9434, 9102, 8765, 8423, 8075,
	7723, 7366, 7005, 6639, 6269, 5896,
	5519, 5139, 4756, 4369, 3980, 3589,
	3196, 2801, 2404, 2005, 1605, 1205,
	803, 402};
#endif
...
#else
    CEVA_TL4_fft_real_32_asm(inst->stages, FFTIOt, fftftemp, CEVA_TL4_cos_sin_fft_32, twi_table_32_rfft_128, bitrev, 1);
#endif
...
#else
    CEVA_TL4_fft_real_inv_32_asm(inst->stages, winDataI, winDataO, CEVA_TL4_cos_sin_fft_32, twi_table_32_rfft_128, bitrev, 1);
#endif
